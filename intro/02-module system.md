...
An Elm program is organized into a collection of modules. Technically speaking, a module is really just one big declaration that groups functionalities that, by some criterion, belong together. 
